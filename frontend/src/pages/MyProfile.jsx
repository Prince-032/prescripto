  ...
  return userData && (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
        ...
        isEdit ?
          <label htmlFor='image'>
            <div className='inline-block relative cursor-pointer'>
              <img className='w-36 rounded opacity-75' src={image ? URL.createObjectURL(image) : userData.image} alt="user_data_image" />
              <img className='w-10 absolute bottom-12 right-12' src={image ? '' : assets.upload_icon} alt="upload_icon" />
      ...
      <div className='mt-10'>
        {
          isEdit
            ? <button className='border border-indigo-500 px-8 py-2 rounded-full hover:bg-indigo-500 hover:text-white transition-all' onClick={updateUserProfile}>Save information</button>
